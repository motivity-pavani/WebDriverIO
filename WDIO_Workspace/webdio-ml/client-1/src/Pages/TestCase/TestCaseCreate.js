                ...
                >
                    ...
                    {payload.methodsList.map((methodRow, index) => {
                        if (methodRow.type === "action") {
                            return <> <Box key={index} sx={{ justifyContent: 'space-between', display: 'flex' }} key={index}>
                                <div key={index}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column" }}>
                                    {index !== 0 && (<IconButton aria-label="Up" onClick={(e) => {
                                        const methodsList = [...payload.methodsList];
                                        var temp = methodsList[index];
                                        methodsList[index] = methodsList[index - 1];
                                        methodsList[index - 1] = temp;
                                        const m = { ...payload }
                                    ...
                                    {payload.methodsList.length == 1 ? null : <IconButton onClick={(e) => {
                                        const methodsList = [...payload.methodsList];
                                        ...
                                        <Avatar> <RemoveCircleIcon /> </Avatar> </IconButton>}
                                    {(index + 1) !== payload.methodsList.length && (<IconButton aria-label="delete" onClick={(e) => {
                                        const methodsList = [...payload.methodsList];
                                        var temp = methodsList[index];
                                        methodsList[index] = methodsList[index + 1];
                                        methodsList[index + 1] = temp;
